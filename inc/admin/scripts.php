<?php 
	...
	class addScripts {
		...
		public function dataTables() {
			wp_register_style('datatables.min.css', COM6_DIR . 'inc/libs/admin/dataTables/css/datatables.min.css', array(), false, 'all');
			wp_enqueue_style('datatables.min.css');
			wp_register_script( 'datatables.min.js', COM6_DIR . 'inc/libs/admin/dataTables/js/datatables.min.js' );
			wp_enqueue_script( 'datatables.min.js' );
			wp_register_script( 'dataTables.buttons.min.js', COM6_DIR . 'inc/libs/admin/dataTables/js/dataTables.buttons.min.js' );
			wp_enqueue_script( 'dataTables.buttons.min.js' );
			wp_register_script( 'jszip.min.js', COM6_DIR . 'inc/libs/admin/dataTables/js/jszip.min.js' );
